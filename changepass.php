...
<head>
    ...
    <style>
        body {
            background: #D9CBA3; /* Light brown background */
            display: flex;
        ...
        .container {
            background: #FFF4E6; /* Off-white for contrast */
            padding: 30px;
            border-radius: 12px;
        ...
        input:focus {
            border-color: #8B5A2B; /* Darker brown on focus */
            outline: none;
        }
        button {
            width: 100%;
            padding: 12px;
            background: #8B5A2B; /* Dark brown for buttons */
            border: none;
            color: white;
            font-size: 16px;
            border-radius: 8px;
        ...
        button:hover {
            background: #6A4B3A; /* Darker brown on hover */
        }
        .back-button {
